...
for it=iters
    ...
    N1 = 2; jobclass{1} = ClosedClass(model, 'ClassA', N1, station{1});
    N2 = 2; jobclass{2} = ClosedClass(model, 'ClassB', N2, station{1});
    ...
    options.seed = 23000;
    options.verbose = 0; jmtoptions = options; jmtoptions.samples = 1e6;
    if needSim
