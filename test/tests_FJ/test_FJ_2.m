...
jobclass{2} = OpenClass(model, 'Class2');

station{1}.setArrival(jobclass{1},Exp(0.5));
station{2}.setService(jobclass{1},Exp(1));
station{1}.setArrival(jobclass{2},Exp(0.1));
station{2}.setService(jobclass{2},Exp(2));

model.addLink(station{1},station{2});
model.addLink(station{1},station{3});
...
station{1}.setProbRouting(jobclass{1}, station{3}, 0.0);
...
station{1}.setProbRouting(jobclass{2}, station{2}, 0.0);
station{1}.setProbRouting(jobclass{2}, station{3}, 1.0);
station{3}.setProbRouting(jobclass{2}, station{4}, 1.0);
station{3}.setProbRouting(jobclass{2}, station{5}, 1.0);
station{4}.setProbRouting(jobclass{2}, station{5}, 1.0);
