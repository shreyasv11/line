...
for n=100 %[10,50,100]
    for nmr=[2,4,10]
        for a=[0.6,1.0,1.4]
            ...
            kset=1:n;
            R={};
            r=c*ones(model.getNumberOfClasses,n,h);
            for k=1:n
            ...
            if c==0.1
                save(sprintf('listbased0.1-%s-%d-%d-%d-%d-%d-%d-%d-%0.2f-%0.2f.mat',rp,n,m(1),m(2),m(3),samples,N(1),N(2),alpha(1),alpha(2)));
            elseif c==0.5
                save(sprintf('listbased0.5-%s-%d-%d-%d-%d-%d-%d-%d-%0.2f-%0.2f.mat',rp,n,m(1),m(2),m(3),samples,N(1),N(2),alpha(1),alpha(2)));
            else
                save(sprintf('listbased-%s-%d-%d-%d-%d-%d-%d-%d-%0.2f-%0.2f.mat',rp,n,m(1),m(2),m(3),samples,N(1),N(2),alpha(1),alpha(2)));
            end
