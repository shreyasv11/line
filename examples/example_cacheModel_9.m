...
for n=[10,50,100]
	...
	h = 2;
        ...
        %save(sprintf('AvgTable-%d-%d-%d-%d-%d-%0.2f-%0.2f.mat',n,m,samples,N(1),N(2),alpha(1),alpha(2)));
        save(sprintf('think-list2-%s-%d-%d-%d-%d-%d-%d-%0.2f-%0.2f-%0.2f-%0.2f.mat',rp,n,m(1),m(2),samples,N(1),N(2),alpha(1),alpha(2),S11,S22));
       	end 
	end
    end
end
