    ...
    for n=100%[100,50,10]
        for nmr=[10,4,2]
            for a=1.4%[1.4,1,0.6]
                ...
                P{hitClass1, initClass2}(3,1)=1;
                P{missClass1, missClass1}(2,4)=1;
                P{missClass1, initClass2}(4,1)=1;
                
                P{initClass2, initClass2}(1,2)=1;
                P{hitClass2, hitClass2}(2,3)=1;
                P{hitClass2, initClass1}(3,1)=1;
                P{missClass2, missClass2}(2,4)=1;
                P{missClass2, initClass1}(4,1)=1;
                ...
                while goon
                    ...
                    %%
                    pHit = 1-MU./Xtot';
                    AvgTableNet = example_cacheModel_6_sub1(S,N,pHit);
