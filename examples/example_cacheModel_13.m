...
for r=1:length(rpcell)
    ...
    for n=10%[100,50,10]
		...
		N = [N1,N1];
                ...
                hitDelay = Queue(model,'HitQ',SchedStrategy.FCFS);
                missDelay = Queue(model,'MissQ',SchedStrategy.FCFS);
	%	missDelay.setNumberOfServers(2);
                ...
                save(sprintf('nochainsisrv-%s-%d-%d-%d-%d-%d-%d-%0.2f-%0.2f.mat',rp,n,m(1),m(2),samples,N(1),N(2),alpha(1),alpha(2)));
